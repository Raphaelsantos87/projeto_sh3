...
if (!isset($_SESSION["nome2"]) || !isset($_SESSION["senha2"])) {;
}
?>
...
<body>
    ...
    <div class="tela-login_2">
        ...
        <form action="logar_2.php" method="POST">
            <input class="adm-login" type="text" name="nome2" placeholder="login">
            <br><br>
            <input class="adm-pass" type="password" name="senha2" placeholder="password">
            <br><br>
